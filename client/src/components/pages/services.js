      ...
      <Container maxWidth="xl" component="main" sx={{ flexGrow: 1, py: 0 }}>
        <Grid container justifyContent="center" alignItems="center" sx={{ minHeight: '100vh', position: 'relative' }}>
          ...
          <Grid item xs={12} sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
            <Typography variant="h1" component="h2" sx={{ color: '#892CDC', ...styles.alegreyaFont,fontSize: { xs: '3.5rem', md: '4.5rem' }, mb: 2 }}>
              Services
            </Typography>
            <Typography variant="h6" sx={{ color: '#892CDC',...styles.alegreyaFont, fontSize: { xs: '1.5rem', md: '2rem' }, maxWidth: '600px', mx: 'auto' }}>
                Service Excellence for Student Success!
            </Typography>
          </Grid>
        </Grid>
      </Container>
